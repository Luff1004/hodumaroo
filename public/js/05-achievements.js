...
const ACHIEVEMENTS = [
  ...
  {id:'br_end_fun', name:'파티는 끝났다',      desc:'LEVEL FUN=)의 케이크 3개를 모아 황금 문으로 탈출', reward:{stardrops:2,coins:100000}, cond:'(achStats.brEndFun||0)>=1'},
  {id:'br_end_garage',name:'지하의 끝',        desc:'주차장의 발전기 3개를 켜고 탈출',      reward:{coins:60000,energy:60000}, cond:'(achStats.brEndGarage||0)>=1'},
  {id:'br_end_pool',name:'배수 완료',          desc:'수영장의 밸브 3개를 잠그고 탈출',      reward:{coins:70000,energy:70000}, cond:'(achStats.brEndPool||0)>=1'},
  {id:'br_end_field',name:'지평선 너머',       desc:'끝없는 갈대밭의 지평선에 닿았다',      reward:{stardrops:1,coins:50000}, cond:'(achStats.brEndField||0)>=1'},
