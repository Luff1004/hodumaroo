...
const JOBS = [
  ...
  {id:'egg_job_partygoer',name:'파티고어의 손님',icon:'🎈',price:0,eggOnly:true,rarity:'legendary',
   desc:'백룸 LEVEL FUN=)에서 살아 돌아온 자. 풍선과 함께 미소짓는 법을 배웠다.',
   color:'#c9a227',skinBg:'linear-gradient(135deg,#451a03,#92400e)',
   skills:[{key:'E',name:'풍선 폭탄',icon:'🎈',desc:'전방 부채꼴로 풍선탄 5개 투척, 명중 시 폭발',cd:600,fn:'jobSkillE'}]},
  {id:'egg_job_dimensiontraveler',name:'차원 여행자',icon:'🌀',price:0,eggOnly:true,rarity:'mythic',
   desc:'에일리언 차원을 다섯 번 넘나든 자. 차원 사이의 틈을 다룰 수 있게 됐다.',
   color:'#7c3aed',skinBg:'linear-gradient(135deg,#1e0a3c,#4c1d95)',
   skills:[{key:'E',name:'차원 도약',icon:'🌀',desc:'마우스 위치로 즉시 순간이동 + 2초 무적',cd:600,fn:'jobSkillE'}]},
