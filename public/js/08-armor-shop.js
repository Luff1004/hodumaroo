...
const ARMORS=[
  ...
  {id:'storm_worksuit',rarity:'transcendent',name:'폭풍 작업복',icon:'🌪️',price:99990000,def:65,bc:'#8b5cf6',ac:'#7c3aed',desc:'방어+65%, 이동속도+2, 보라색 연기 오라',bonus:{spd:2,dmg:5}},
  {id:'storm_worksuit_ultimate',rarity:'transcendent',name:'폭풍 작업복 얼티메이트',icon:'⚡',price:0,def:85,bc:'#4c0519',ac:'#be123c',desc:'[업적 보상] 방어+85%, 이동속도+3, 데미지+15, 폭풍 피해 면역, 강렬한 붉은 오라',bonus:{spd:3,dmg:15,stormImmune:true},achOnly:true},
